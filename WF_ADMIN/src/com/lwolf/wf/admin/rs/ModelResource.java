...
public interface ModelResource {
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Path("{modelId}")
	public ModelDto read(@PathParam("modelId") Integer modelId);
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Path("{modelId}")
	public ModelDto delete(@PathParam("modelId") Integer modelId);
	
	@GET
	@Path("{modelId}/file")
	public Response getFile(@PathParam("modelId") Integer modelId);
